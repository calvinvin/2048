...
export class GameController {
  ...
  attachSwipeControl() {
    ...
    let moved = false;
    const pointerDownHandler = handlePointerDown.bind(this);
    const pointerMoveHandler = handlePointerMove.bind(this);
    const pointerUpHandler = handlePointerUp.bind(this);
